...
// TestMFC.cpp : Определяет поведение классов для приложения.
//
...
// Единственный объект CTestMFCApp

CTestMFCApp theApp;


// инициализация CTestMFCApp
...
// обработчики сообщений CTestMFCApp
